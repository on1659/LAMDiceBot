...
const DEFAULT_GAME_STATS = () => ({ dice: { count: 0, totalParticipants: 0 }, roulette: { count: 0, totalParticipants: 0 }, 'horse-race': { count: 0, totalParticipants: 0 }, ladder: { count: 0, totalParticipants: 0 }, 'spin-arena': { count: 0, totalParticipants: 0 }, 'pirate': { count: 0, totalParticipants: 0 } });
