...
2. **PNG 복사**
   ...
   - **최적화(필수):** 복사한 PNG 에 `pngquant --quality 80-100 --speed 1 --strip --force --ext .png {files}` (품질 하한 실패 exit 99 면 `60-100` 으로 재시도 후 확대 비교). 기준·검증은 `docs/GameGuide/04-ops/image-assets.md`
