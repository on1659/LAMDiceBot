---
name: "source-command-spritemake-pickup"
description: "SpriteMake batch 인수 — final/ PNG를 게임 assets/로 옮기고 매핑 갱신"
---

# source-command-spritemake-pickup

Use this skill when the user asks to run the migrated source command `spritemake-pickup`.
...
batch-name 생략 시 `.Codex/inbox/spritemake-done-*.md` 마커 파일에서 가장 최근 것을 자동 선택.
...
1. **마커 확인**
   - `.Codex/inbox/spritemake-done-{batch-name}.md` 읽기
...
5. **의뢰서 이동**
   ...
   - inbox 마커 삭제: `.Codex/inbox/spritemake-done-{batch-name}.md`
