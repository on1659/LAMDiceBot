...
(async () => {
    ...
    const rank = sim.rankPlayers(balls, r.finishOrder, participants);
    const payload = {
    ...
    console.log('selected:', rank.selected, '| last ball:', JSON.stringify(balls[r.finishOrder[r.finishOrder.length - 1]]));
