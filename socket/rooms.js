        ...
        socket.emit('currentRoomInfo', {
            ...
            gameState: {
                ...
                spinArena: gameState.spinArena
                    ? { phase: gameState.spinArena.phase, skins: gameState.spinArena.skins, rankVotes: gameState.spinArena.rankVotes, dispositions: gameState.spinArena.dispositions, round: gameState.spinArena.round, history: gameState.spinArena.history }
                    : undefined,
